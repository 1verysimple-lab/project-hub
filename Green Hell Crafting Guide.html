...
import { Search, PenTool, Sword, Shield, Activity, Home, Hammer, Menu, X, Info, Leaf, Box, Utensils, Sprout, Cat, Skull } from 'lucide-react';
...
export default function GreenHellGuide() {
